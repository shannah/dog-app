...
package com.github.shannah.dogapp;
 ...
 * @author Shai Almog
 */
public class {{ mainClassName }}Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Dog App";
    private static final String APP_NAME = "dog-app";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new {{ mainClassName }}Stub());
    }
